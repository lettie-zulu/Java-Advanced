...
// Create several customers and their accounts
        ...
        bank.addCustomer("Nipho", "Modise");
        customer = bank.getCustomer(2);
        customer.addAccount(new CheckingAccount(1000.00, 5000.00));

        bank.addCustomer("Oratiloe", "Zulu");
        customer = bank.getCustomer(3);
        customer.addAccount(new CheckingAccount(200.00));

        bank.addCustomer("Smangele", "Gundana");
        customer = bank.getCustomer(4);
        customer.addAccount(new CheckingAccount(200.00));

        bank.addCustomer("Maggie", "Modise");
